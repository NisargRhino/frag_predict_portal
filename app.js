document.getElementById('inputForm').addEventListener('submit', function(event) {
    ...
    async function fetch2DStructure(smiles, imgElement) {
        try {
            const response = await fetch('https://nisargrhino.github.io/frag_predict_portal/get_2d_structure', {
                method: 'POST',
                headers: {
    ...
    async function fetch3DStructure(smiles, viewerElement, downloadElement, filename) {
        try {
            const response = await fetch('https://nisargrhino.github.io/frag_predict_portal/get_3d_structure', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            downloadElement.onclick = async function() {
                try {
                    const response = await fetch('https://nisargrhino.github.io/frag_predict_portal/download_pdb', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
    ...
    async function predictFragment(smiles, suffix) {
        try {
            const response = await fetch('https://nisargrhino.github.io/frag_predict_portal/predict_fragment', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function fetchScore(smiles) {
        try {
            const response = await fetch('https://nisargrhino.github.io/frag_predict_portal/score', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function combineFragments(smiles1, smiles2) {
        ...
        try {
            const response = await fetch('https://nisargrhino.github.io/frag_predict_portal/combine', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
